...
<!--            &lt;!&ndash; Google Login Button &ndash;&gt;-->
<!--            <Button-->
<!--                type="button"-->
<!--                variant="outline"-->
...
<!--            &lt;!&ndash; Regular Login Form &ndash;&gt;-->
...
<!--&lt;!&ndash;                            <TextLink v-if="canResetPassword" :href="route('password.request')" class="text-sm" :tabindex="5">&ndash;&gt;-->
<!--&lt;!&ndash;                                Forgot password?&ndash;&gt;-->
<!--&lt;!&ndash;                            </TextLink>&ndash;&gt;-->
<!--                        </div>-->
<!--                        <Input-->
<!--                            id="password"-->
<!--                            type="password"-->
...
<!--&lt;!&ndash;                <TextLink :href="route('register')" :tabindex="6">Sign up</TextLink>&ndash;&gt;-->
<!--            </div>-->
<!--        </div>-->
<!--    </AuthBase>-->
<!--</template>-->
