        ...
        <div class="p-4">
            <div class="card rounded-lg bg-white p-6 shadow-sm">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Update user information, roles, and settings</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :value="`#${user.id}`"
                                    readonly
                                    class="w-full rounded-lg border border-gray-300 px-3 py-2 bg-gray-50 text-gray-500"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-8">
                        ...
                        <div v-if="showPasswordSection" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- New Password -->
                            <div>
                    ...
                    <div class="border-b border-gray-200 pb-8">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Select the roles to assign to this user. Users inherit permissions from their assigned roles.</p>

                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div v-for="role in availableRoles" :key="role.id" :class="[
                    ...
                    <div v-if="form.roles.length > 0" class="bg-blue-50 rounded-lg p-4">
                        <h3 class="text-sm font-medium text-blue-900 mb-2">Selected Roles Preview</h3>
                    ...
                    <div class="flex items-center justify-between pt-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button
                                ...
                                :class="[
                                    'rounded-lg px-6 py-2 text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2',
                                    form.processing
