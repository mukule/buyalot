...
import type { AppPageProps, User, Role, Permission } from '@/types';
...
function updateUserStatus() {
    router.post(route('admin.users.update-status', user.value.id), {
            ...
            <div class="card rounded-lg bg-white p-6 shadow-sm">
                <div class="flex items-start justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mt-2">
                                ...
                                <span v-if="user.email_verified_at" class="rounded-full bg-green-100 text-green-800 px-3 py-1 text-sm font-medium">
                                    Email Verified
                                </span>
                                <span v-else class="rounded-full bg-yellow-100 text-yellow-800 px-3 py-1 text-sm font-medium">
                                    Email Unverified
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-3">
                        <button
                            @click="openRoleModal"
                            class="rounded-lg bg-primary px-4 py-2 text-white hover:bg-primary-dark"
                        >
                            Manage Roles
                        </button>
                        <button
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="card rounded-lg bg-white p-6 shadow-sm">
                        ...
                        <div v-if="user.permissions.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                            <span
                ...
                <div class="space-y-6">
                    ...
                    <div class="card rounded-lg bg-white p-6 shadow-sm">
                        ...
                        <div class="space-y-2">
                            <button
                                @click="router.get(route('admin.users.edit', user.id))"
                                class="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg flex items-center gap-2"
                            >
                            ...
                            >
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v-2l-4.257-2.257A6 6 0 0112 5h3m2 5v2a2 2 0 01-2 2h-2m-6-4h2a2 2 0 012 2v2a2 2 0 01-2 2h-2v4h.01"></path>
                                </svg>
                                Reset Password
                            </button>
                        </div>
                    ...
                    <form @submit.prevent="updateUserStatus">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button
                                ...
                                :class="[
                                    'w-full justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm',
                                    statusForm.processing ? 'bg-gray-400 cursor-not-allowed' : 'bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-500'
                                ]"
