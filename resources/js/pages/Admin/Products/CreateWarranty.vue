...
// Extend Inertia PageProps with product info
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-4">
            <div class="flex flex-col space-y-4 rounded-xl bg-white p-4 text-[color:var(--card-foreground)]">
                ...
                <!-- Form -->
                <form @submit.prevent="form.post(route('admin.products.warranties.store', { product: product.hashid }))" class="mt-2 space-y-4 px-4">
