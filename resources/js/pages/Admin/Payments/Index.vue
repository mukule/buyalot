...
import { SearchIcon, Eye } from 'lucide-vue-next'
...
<template>
    ...
    <AppLayout :breadcrumbs="[{ title: 'Dashboard', href: route('admin.dashboard') }, { title: 'Payments', href: route('admin.payments.index') }]">
        <div class="p-4">
                ...
                <div class="mb-4 flex">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            class="pl-10 block w-full rounded-md border border-gray-300 py-2 text-sm focus:border-primary-500 focus:ring-primary-500"
                        />
                    </div>
                </div>
                ...
                <div v-if="payments.length" class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr v-for="payment in payments" :key="payment.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4 text-sm capitalize" :class="{
