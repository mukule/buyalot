        ...
        <div class="p-4">
            <div class="card flex flex-col gap-6 rounded-lg bg-white p-4 shadow-sm">
                ...
                <ul class="list-none divide-y divide-gray-200">
                    <li v-for="(permission, index) in permissions" :key="permission.hashid" class="flex items-center justify-between px-4 py-3">
                        ...
                        <div class="space-x-4">
                            <button @click="editPermission(permission.hashid)" class="text-sm text-primary hover:underline">Edit</button>
