...
watch([() => searchForm.search, () => searchForm.module], () => {
    search();
}, { debounce: 300 });
</script>
            ...
            <div class="card flex flex-col gap-6 rounded-lg bg-white p-4 shadow-sm">
                ...
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center">
                        ...
                        <!-- Clear Filters -->
                        <button
                            v-if="searchForm.search || searchForm.module"
                            @click="clearFilters"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button
                            ...
                            :class="[
                                ...
                                showGrouped ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700'
                            ]"
                        >
                            Grouped
                        </button>
                    ...
                    >
                        ...
                        <div v-if="expandedModules[module]" class="divide-y divide-gray-100">
                            ...
                            >
                                ...
                                <div class="flex items-center gap-2">
                                    <button
                                        @click="goToPermissionShow(permission.hashid)"
                                        class="text-sm text-blue-600 hover:underline"
                                    >
                                        View
                                    </button>
                                    <button
                                        @click="goToPermissionEdit(permission.hashid)"
                ...
                <div v-if="permissions.length === 0" class="py-12 text-center">
                    ...
                    <div class="mt-6">
                        <button v-if="!filters.search && !filters.module" @click="goToCreatePage" class="inline-flex items-center rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-dark">
                            + New Permission
                        </button>
                        <button v-else @click="clearFilters" class="inline-flex items-center rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700">
                            Clear Filters
                        </button>
                    </div>
                </div>
