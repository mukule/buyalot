...
const selectedRoleForPermissions = ref<(Role & { permissions: Permission[]; hashid: string }) | null>(null);
...
function openPermissionModal(role: Role & { permissions: Permission[]; hashid: string }) {
...
function updateRolePermissions() {
    ...
    // console.log(Ziggy);
    router.put(
        route('admin.roles.update', selectedRoleForPermissions.value.hashid),
        {
...
function isModuleSelected(module: string): boolean {
    const modulePermissions = groupedPermissions.value[module];
    return modulePermissions.every((permission) => permissionForm.permissions.includes(permission.id.toString()));
}

function isModulePartiallySelected(module: string): boolean {
    const modulePermissions = groupedPermissions.value[module];
    const selectedCount = modulePermissions.filter((permission) => permissionForm.permissions.includes(permission.id.toString())).length;
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
            ...
            <div class="card flex flex-col gap-6 rounded-lg bg-white p-4 shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                    <div class="rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 p-4 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-blue-100">Total Roles</p>
                    ...
                    <div class="rounded-lg bg-gradient-to-r from-green-500 to-green-600 p-4 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-green-100">Active Roles</p>
                    ...
                    <div class="rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 p-4 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-purple-100">Total Permissions</p>
                    ...
                    <div class="rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 p-4 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-orange-100">Permission Modules</p>
                ...
                <div v-if="showBulkActions" class="flex items-center gap-4 rounded-lg bg-blue-50 p-4">
                    ...
                    <button @click="selectedRoles = []" class="text-sm text-blue-600 hover:text-blue-800">Clear Selection</button>
                </div>
                    ...
                    >
                        ...
                        <div class="mb-4 flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-500">{{ role.permissions.length }} permissions</p>
                            </div>
                        </div>

                        <!-- Permissions Preview -->
                        <div class="mb-4">
                            <p class="mb-2 text-sm font-medium text-gray-700">Key Permissions:</p>
                        ...
                        <div class="flex items-center justify-between border-t border-gray-100 pt-4">
                            <div class="flex items-center gap-2">
                                <button @click="goToRoleShow(role.hashid)" class="text-sm text-blue-600 hover:underline">View</button>
                                <button
                            ...
                            <div class="flex items-center gap-2">
                                <button
                                    ...
                                    class="hover:bg-primary-dark rounded bg-primary px-3 py-1 text-xs text-white"
                                >
                                    Permissions
                                </button>
                                <button
        ...
        <div v-if="showPermissionModal" class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="bg-opacity-75 fixed inset-0 bg-gray-50 backdrop-blur-sm transition-opacity" @click="showPermissionModal = false"></div>
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 w-full text-center sm:mt-0 sm:text-left">
                                    ...
                                    <div class="max-h-96 space-y-4 overflow-y-auto">
                                        <div v-for="(modulePermissions, module) in groupedPermissions" :key="module" class="rounded-lg border p-4">
                                            <div class="mb-3 flex items-center justify-between">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        @change="
                                                            (event: Event) =>
                                                                toggleModulePermissions(module, (event.target as HTMLInputElement).checked)
                                                        "
                                                    />
                            ...
                            <button
                                ...
                                :class="[
                                    ...
                                    permissionForm.processing
                                        ...
                                        : 'hover:bg-primary-dark bg-primary focus:ring-primary',
                                ]"
