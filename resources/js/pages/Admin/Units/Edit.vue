...
function submit() {
    form.put(`/admin/unit-types/${unitType.hashid}`);
}
</script>
        ...
        <div class="p-4">
            <div class="flex h-full flex-1 flex-col space-y-4 rounded-xl bg-white p-4 text-[color:var(--card-foreground)]">
                <div class="flex items-center justify-between">
                    ...
                    <Link href="/admin/unit-types" class="text-sm text-[color:var(--primary)] hover:underline">← Back</Link>
                </div>
